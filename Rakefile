...
namespace :assets do
  Rake::SprocketsTask.new do |t|
    ...
    t.assets      = %w( boot.js application.css chosen-sprite.png stream_sprites.png topbar_sprites.png stream_sprites@2x.png topbar_sprites@2x.png texture.png bodytexture.png )
